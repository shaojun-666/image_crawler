...
- **翻页检测与批量爬取** — 自动检测页面翻页机制，支持单页、全部页面或自定义页码范围爬取
- **"显示更多"自动点击** — 自动检测并点击"加载更多"按钮，爬取动态加载的图片（上限 100 张）
...
4. **开始爬取** — 点击"开始爬取"
5. **翻页选择** — 若检测到翻页机制，弹窗询问是否爬取其他页面（仅当前页/全部页面/自定义页码范围）
6. **等待爬取** — 程序自动爬取所选页面，如有"显示更多"按钮会自动点击加载
7. **勾选图片** — 在预览区域勾选需要保存的图片（默认全选）
8. **保存选中** — 点击"保存选中图片"，图片将保存到指定目录
